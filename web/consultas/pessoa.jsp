<%-- 
    Document   : pessoa
    Created on : 24/11/2010, 15:05:03
                                ...
                                <td class="Txt" align="center">
                                    ...
                                    <table border="0" align="center" cellpadding="2" cellspacing="2" width="100%" >
                                        ...
                                        <tr align="center" valign="middle">
                                            ...
                                            <td>
                                                <a href="../consultas/editar_pessoa.jsp?op=2&amp;idPessoa=<%out.print(achei.getIdPessoa());%>">
                                                    <img src="../images/img_caderno_transparente.png" width="30" height="30" border="0" alt="editar" title="editar"/>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="../consultas/excluir_pessoa.jsp?idPessoa=<%out.print(achei.getIdPessoa());%>">
